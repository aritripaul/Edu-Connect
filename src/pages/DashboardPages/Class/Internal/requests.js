    ...
    <Card onClick={props.handleClick} sx={{ maxWidth: 340, m: 2 }}>
        ...
        <CardActions>
            <Button
                ...
                onClick={() => {
                    props.handleAction(props.username, true)
                }}>
                Accept
            </Button>
            <Button
                onClick={() => {
                    console.log('re')
                    props.handleAction(props.username, false)
                }}
                disabled={props.loading}>
                Reject
            </Button>
...
function Page(props) {
    ...
    const fetch = async () => {
        ...
        try {
            ...
            const res = await apiInstance.get(
                GET_REQUESTS + id + '/?verified=false'
            )
    ...
    const handleAction = async (username, verify) => {
        setLoading(true)
        ...
        try {
            const { data } = await apiInstance.put(VERIFY + id + '/', body)
